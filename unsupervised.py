...
VALIDATION_METRIC = 'mean_cosine-csls_knn_10-S2T|T2S-100'
...
parser.add_argument("--dico_max_size", type=int, default=300, help="Maximum generated dictionary size (0 to disable)")
# reload pre-trained embeddings
parser.add_argument("--src_emb", type=str, default="", help="Reload source embeddings")
parser.add_argument("--tgt_emb", type=str, default="", help="Reload target embeddings")
parser.add_argument("--normalize_embeddings", type=str, default="", help="Normalize embeddings before training")

parser.add_argument("--identical_dict_path", type=str, default="dict/candidates_dict.txt", help="Path to synthetic dictionary")
